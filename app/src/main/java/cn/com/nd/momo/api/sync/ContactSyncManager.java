...
public class ContactSyncManager {
    ...
    private Contact convertJsonToContact(JSONObject info, boolean isNew) {
        if (null == info)
            return null;
        Contact contact = null;
        try {
            long contactId = info.getLong(KEY_ID);
            String formatName = info.getString("formatted_name");
            String lastName = info.getString("family_name");
            ...
            long modified = info.getLong("modified_at");
            long userId = info.optLong("user_id");
            String name = info.optString("name");
            int userStatus = info.optInt("user_status");
            int userLink = info.optInt("user_link");
            int gender = info.optInt("gender");
            String residence = info.optString("residence");
            String lunarBirthday = info.optString("lunar_bday");
            boolean needLunar = info.optBoolean("is_lunar");
            String animalSign = info.optString("animal_sign");
            String zodiac = info.optString("zodiac");
            int health = info.optInt("health");
            long phoneCid = info.optLong("phoneCid");
            contact = new Contact(-1, contactId, phoneCid, userId, firstName, lastName,
                    organization, department, note, birthDayStr, title, nickName, modified,
                    formatName, false, name, userStatus, userLink, gender, residence,
            ...
            JSONArray telsArray = info.getJSONArray("tels");
            ...
            JSONArray urlsArray = info.getJSONArray("urls");
            ...
            JSONArray imsArray = info.getJSONArray("ims");
            ...
            JSONArray eventsArray = info.getJSONArray("events");
            ...
            relationsArray = info.getJSONArray("relations");
